    ...
    addEventListener("load",function(){
        ...
        document.getElementById("player").addEventListener("click",function(){
            try{
                //alert('name: '+document.getElementById("play").getAttribute("name"));
                if(document.getElementById("play").getAttribute("name") === "play"){
                    pause = false;
                    
                    //document.getElementsByClassName("fa fa-play").setAttribute("name","pause");
                    ...
                    //document.getElementsByClassName("fa fa-play").setAttribute("class","fa fa-pause");
                    return false;
                }else if(document.getElementById("play").getAttribute("name") === "pause"){
                    audio.pause();
                    pause = true;
                    timeActual = audio.currentTime;
                    //document.getElementsByClassName("fa fa-play").setAttribute("class","fa fa-pause");
                    //document.getElementsByClassName("fa fa-play").setAttribute("name","play");
        ...
        document.getElementById("stop").addEventListener("click",function(){
            stop = true;
            clearInterval(id);
            //document.getElementsByClassName("fa fa-pause").setAttribute("class","fa fa-play");
            document.getElementById("play").innerHTML= "<i class='fa fa-play'></i>";
            document.getElementById("play").setAttribute("name","play");
            pause = true;
            timeActual = 0;
            ...
            for(i =0 ; i < linea.length ; i++){
                if(linea[i].getAttribute("name") === colorTag){
                    ...
                    linea[i].style.backgroundPosition = "center";
                    linea[i].style.backgroundRepeat = "no-repeat";
                    linea[i].style.backgroundImage = "url('imagenes/pointer.png')";
                    linea[i].setAttribute("name",colorTag);
                }
                else{
                    linea[i].style.background = color;
        ...
        document.getElementById("addTag").addEventListener("click",function(){
            try{
                ...
                http_request_add_memo.onreadystatechange = alertContentsAdd;
        ...
        document.getElementById("mute").addEventListener("click",function(){
            try{
                ...
                if(fotoVolumen.getAttribute("name") === "mute"){
                    ...
                    document.getElementsByClassName("fa fa-volume-up").setAttribute("class","fa fa-volume-off");
                    ...
                    document.getElementsByClassName("fa fa-volume-off").setAttribute("class","fa fa-volume-up");
        ...
        if (width >= audio.duration) {
            ...
            if(!pause){
                ...
                if(document.getElementById(width).getAttribute("name") === colorTag){
                    ...
                    document.getElementById(width).setAttribute("name",colorTag);
                    document.getElementById(width).style.backgroundRepeat = "no-repeat";
                    document.getElementById(width).style.backgroundPosition = "center";
                    document.getElementById(width).style.backgroundImage = "url('imagenes/pointer.png')";
                }
                else{
                    document.getElementById(width).style.background = colorAvance;
        ...
        if (http_request_add_memo.readyState === 4) {
            if (http_request_add_memo.status === 200) {
                if(http_request_add_memo.responseText !== "xxx"){
                    ...
                    document.getElementById(parseInt(audio.currentTime)+"").style.backgroundPosition = "center";
                    document.getElementById(parseInt(audio.currentTime)+"").style.backgroundRepeat = "no-repeat";
                    document.getElementById(parseInt(audio.currentTime)+"").style.backgroundImage = "url('imagenes/pointer.png')";
                    ...
                    for(i = 0; i <string.length;i++){
                        try{
                            ...
                            linea[parseInt(string[i].split("%separador%")[1])].style.backgroundPosition = "center";
                            linea[parseInt(string[i].split("%separador%")[1])].style.backgroundRepeat = "no-repeat";
                            linea[parseInt(string[i].split("%separador%")[1])].style.backgroundImage = "url('imagenes/pointer.png')";
            ...
            if (http_request_get_memo.status === 200) {
                ...
                for(i = 0; i <string.length;i++){
                    try{
                        ...
                        linea[parseInt(string[i])-1].style.backgroundPosition = "center";
                        linea[parseInt(string[i])-1].style.backgroundRepeat = "no-repeat";
                        linea[parseInt(string[i])-1].style.backgroundImage = "url('imagenes/pointer.png')";
    ...
    function reproducir(grabacion,archivo,idLlamada){
        ...
        if(navegador() === 0){
            audio = new Audio("escucha?wav=wav&rutaArchivo="+grabacion+"&archivo="+archivo);
        }else{
            audio = new Audio("escucha?rutaArchivo="+grabacion+"&archivo="+archivo);
        }
        var foto = document.getElementById("play");
        ...
        audio.addEventListener('loadedmetadata', function() {
            ...
            //document.getElementsByClassName("fa fa-play").setAttribute("class","fa fa-pause");
            foto.innerHTML= "<i class='fa fa-pause'></i>";
        ...
        audio.addEventListener('ended',function(){
            ...
            clearInterval(id);
            //document.getElementsByClassName("fa fa-pause").setAttribute("class","fa fa-play");
            foto.innerHTML= "<i class='fa fa-play'></i>";
