$(document).ready(function(){
    ...
    $("#llamadaGralPool").mouseover(function(){
        $("#panel").hide();
        $("#panel").css("background-image","url('imagenes/diario/llamadaGralPool.jpg')");
        $("#panel").show();
    });
    ...
    $("#llamadaGralPool").click(function(){
        ...
        $("#promedioRingeoPool").hover(function(){
            $("#panel").hide();
            $("#panel").css("background-image","url('imagenes/mensual/promedioRingeoPool.jpg')");
            $("#panel").show();
        });
        ...
        $("#promedioLlamadaPool").hover(function(){
            $("#panel").hide();
            $("#panel").css("background-image","url('imagenes/mensual/promedioLlamadaPool.jpg')");
            $("#panel").show();
        });
    ...
    function getPiloto(url) {
        $.ajax({
            ...
            url:url,
            timeout:10000,
            data:"sesion="+$("#perfil").val()+"&idPiloto="+$("#idpilas").val(),
            success:
               function(datos){
