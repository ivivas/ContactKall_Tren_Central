...
function dropdown_menu_hack(el) {
    ...
    function showMenu() {        
        ...
        //Este selectMenu lo agregue para que no envie nada por el menu 0 "Todos"
        function selectMenu0(obj) {
            var o = document.createElement("option");
            o.value = '';
            o.innerHTML = obj.innerHTML;			
            while(el.options.length>0){el.options[0].removeNode(true);}
        ...
        for(var i=0;i<mb.options.length;i++) {
            ...
            mb.options[i].onmouseover = function() {
                ...
                this.style.background="#3366CC";this.style.color="white";
            }
            ...
            if (i>0) {
                ...
                mb.options[i].onmouseout = function(){this.style.background="white";this.style.color="black";}
                mb.options[i].onmousedown = function(){selectMenu0(this);}
                mb.options[i].onkeydown = function(){selectMenu0(this);}
            }
            
            if(i == el.contentIndex) {
                mb.options[i].style.background="#3366CC";
